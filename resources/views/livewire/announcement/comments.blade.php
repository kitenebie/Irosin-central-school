<div>
                                    ...
                                    <button class="flex items-center gap-1 hover:text-gray-800 relative"
                                        ...
                                        <div class="reaction-popup reaction-popup2 flex" id="reaction-popup-footer"
                                            ...
                                            <img src="/build/img/like.png" class="size-[1.5rem]"
                                                wire:click='react("Like", 1, "post")' role="button" aria-label="Like"
                                                data-reaction="like" title="Like" />
                                            <img src="/build/img/love.png" class="size-[1.5rem]"
                                                wire:click='react("Love", 1, "post")' role="button" aria-label="Love"
                                                data-reaction="love" title="Love" />
                                            <img src="/build/img/haha.png" class="size-[1.5rem]"
                                                wire:click='react("Haha", 1, "post")' role="button" aria-label="Haha"
                                                data-reaction="haha" title="Haha" />
                                            <img src="/build/img/care.png" class="size-[1.5rem]"
                                                wire:click='react("Care", 1, "post")' role="button" aria-label="Care"
                                            ...
                                            <img src="/build/img/angry.png" class="size-[1.5rem]"
                                                wire:click='react("Angry", 1, "post")' role="button" aria-label="Angry"
    ...
    {{-- ?large screen --}}
    <div
        class="bg-white fixed inset-0  absolute sticky hidden  lg:block bottom-0 left-0 right-0 border px-4 max-w-lg h-screen">
        <div class="min-w-[400px] overflow-y-auto h-full p-0 m-0 relative flex flex-col">
