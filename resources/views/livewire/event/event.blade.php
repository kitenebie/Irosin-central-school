<div>
    <div
        ...
        <div id="modal" class="fixed inset-0 hidden bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div
                class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg w-full max-w-sm text-gray-800 dark:text-gray-100">
        ...
        <section class="max-w-7xl mt-6 mx-auto px-6 pb-12">
            ...
            {{-- <div id="event-cards" class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            function executeAll() {
                ...
                function renderCalendar(date) {
                    ...
                    for (let i = 1; i <= totalDays; i++) {
                        ...
                        div.className =
                            `p-2 rounded-lg cursor-pointer relative transition ${
                        ...
                        if (hasEvent) {
                            ...
                            badge.className =
                                "absolute top-1 right-1 bg-green-500 text-white text-xs font-bold px-2 py-0.5 rounded-full";
